        ...
        if answers is None:
            ...
            for i, _ in enumerate(answers['scores']):
                if answers['scores'][i] == max(answers['scores']) and answers['scores'][i] >= score_settings['bad_response_threshold']:
                    flg = False
                    if 'https://' in answers['answers'][i]:
                        print('I am sorry I dont have a proper answer')
                    else:
                        print("{}- {}{} [{}] {}{}{}".format(colorama.Fore.GREEN,answers['answers'][i], colorama.Fore.RESET, answers['scores'][i], colorama.Fore.BLUE, answers['score_modifiers'][i] if score_settings['show_score_modifiers'] else '', colorama.Fore.RESET))
            if flg:
                print('I am sorry i dont have a proper answer')
